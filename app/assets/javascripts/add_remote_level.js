              ...
              <div class="col-sm-5 col-level">
                ...
                <div class="col-sm-12">
                  <select name="medical_record[medical_records_services_attributes][${id}][service_id]" id="medical_record_medical_records_services_attributes_${id}_service_id" class="mdb-select md-form" searchable="Search here..">
                    <option value="1">Tiêm phòng</option>
<option value="2">Cắt tỉa - Tạo kiểu</option>
<option value="3">Tắm - mát xa</option>
<option value="4">Sấy khô toàn thân</option>
<option value="5">Chụp X </option>
<option value="6">Siêu âm</option>
<option value="7">Nhuộm lông</option>
<option value="8">Xét nghiệm</option>
<option value="9">Cấp cứu 24/7</option>
<option value="10">Phẫu thuật</option>
<option value="11">Vệ sinh miệng</option>
<option value="12">Ở nội trú / ngày</option></select>
                  </select>
                </div>
              </div>
            </div>
