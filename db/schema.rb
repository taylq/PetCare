...
ActiveRecord::Schema.define(version: 2019_03_25_103225) do
  ...
  create_table "medical_records_services", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
